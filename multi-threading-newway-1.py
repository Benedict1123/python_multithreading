...
with concurrent.futures.ThreadPoolExecutor() as executor:
    ...
    results = [executor.submit(take_action, duration) for duration in duration_list]
    for f in concurrent.futures.as_completed(results):  # default iterator in the 'concurrent.futures' library
        print(f.result())
